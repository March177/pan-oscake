$(document).ready(function () {
  ...
  $(document).ready(function () {
    $(document).on("click", ".confirm-texts", function () {
      var $this = $(this);
      var menu_id = $this.data("id"); // Assuming data-id contains menu_id
      console.log("menu_id:", menu_id);
      var deleteUrl = "deletemenu.php";
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: deleteUrl,
            type: "POST",
            data: { menu_id: menu_id }, // Send the correct ID
            dataType: "json",
            success: function (response) {
              console.log("Response:", response);
              if (response.success) {
                Swal.fire("Deleted!", response.message, "success");
                $this.closest("tr").remove(); // Assuming the button is in a table row
              } else {
                Swal.fire("Error!", response.message, "error");
              }
            },
