          ...
          <div class="row">
            <div class="col-lg-3 col-sm-6 col-12">
              <div class="dash-widget">
                ...
                <div class="dash-widgetcontent">
                  <h5>
                    <span class="counters" data-count="9.00">7.00</span>
                  </h5>
                  <h6>Total Orders</h6>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
              <div class="dash-widget dash1">
                ...
                <div class="dash-widgetcontent">
                  <h5>
                    ₱<span class="counters" data-count="2445.00">₱2285.00</span>
                  </h5>
                  <h6>Total Sales</h6>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
              <div class="dash-widget dash2">
                ...
                <div class="dash-widgetcontent">
                  <h5>
                    <span class="counters" data-count="7">7</span>
                  </h5>
                  <h6>Total RESERVE</h6>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
              <div class="dash-widget dash3">
                ...
                <div class="dash-widgetcontent">
                  <h5>
                    <span class="counters" data-count="4.00">4</span>
                  </h5>
